<x-app-layout>
    ...
    <div class="w-7xl m-5 px-8 py-8 bg-gray-900 rounded-lg text-red-300">
        {{ session('error') }}
    </div>
    @endif
        ...
        <div class="grid grid-cols-3 gap-2 h-50 p-5  border rounded-lg border-gray-500">
            <div class="col-span-1 text-center flex flex-col justify-around items-center">
                <div class="block w-28">
                    <img class="object-cover rounded-full" src="/storage/{{$craftsman->image}}" alt="Image">
                </div>
            ...
            <div class="col-span-2 h-full flex flex-col justify-around">
                ...
                <div class="flex justify-around items-center">
                    @if ($craftsman->requests)
                    <a href="{{$craftsman->id}}/reviews" class="self-end inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">Reviews ></a>
                    @endif
